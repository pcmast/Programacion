...
public class IniciativaController {
    ...
    public void creaIniciativa() {
        File archivo = new File("iniciativas.xml");
        ArrayList<Iniciativa> iniciativasDesdeXML = new ArrayList<>();
        if (archivo.exists()) {
            iniciativasDesdeXML = XMLManager.readXML(new ArrayList<>(), "iniciativas.xml");
        }
        ...
        if (creado) {
            ...
            XMLManager.writeXML(iniciativa, "iniciativas.xml");
            iniciativasDesdeXML.add(iniciativa);
        } else {
    ...
    public void muestraIniciativas() {
        ...
        for (Iniciativa iniciativa : iniciativasDesdeXML) {
    ...
    public void muestraIniciativasNombre() {
        ...
        ArrayList<Iniciativa> list = creador.verIniciativas();
        if (archivo.exists()) {
        list = XMLManager.readXML(new ArrayList<>(),"iniciativas.xml");
        }
